...
/**
 * Template Part: Top Reasons Section
 *
 * Displays a two-column section with:
 * - Decorative dotted and red background layers
 * - Heading and supporting image
 * - Reasons list with icons, titles, and descriptions
    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row gy-3">
                ...
                <!-- Left column: heading, divider, and image -->
                <div class="col-lg-4">
            ...
            <?php if (! empty($button['url'])) : ?>
                <div class="text-center mt-5">
                    <a
                        class="jnj-btn d-inline-block text-decoration-none text-white"
